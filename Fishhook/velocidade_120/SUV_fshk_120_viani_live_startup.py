...
def launch_command():
  ...
  try:
    vianimator.api.LoadModelCmd('C:/Users/lucas/Desktop/working_dir/SUV_fshk_120_graphics.xgr').execute()
  except:
    pass
  try:
    vianimator.api.LoadModelCmd('C:/Users/lucas/Desktop/working_dir/SUV_fshk_120_road_graphics.xgr').execute()
  except:
    pass
  ...
  viframework.viobjects.simulation.Analysis.setSourceFile(analysis_manager.getAnalysis(modelName),'C:/Users/lucas/Desktop/working_dir/SUV_fshk_120.res')
launch_command()
