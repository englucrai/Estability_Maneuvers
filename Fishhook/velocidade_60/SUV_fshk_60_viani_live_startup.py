...
def launch_command():
  ...
  try:
    vianimator.api.LoadModelCmd('C:/Users/lucas/Desktop/working_dir/SUV_fshk_60_graphics.xgr').execute()
  except:
    pass
  try:
    vianimator.api.LoadModelCmd('C:/Users/lucas/Desktop/working_dir/SUV_fshk_60_road_graphics.xgr').execute()
  except:
    pass
  ...
  viframework.viobjects.simulation.Analysis.setSourceFile(analysis_manager.getAnalysis(modelName),'C:/Users/lucas/Desktop/working_dir/SUV_fshk_60.res')
launch_command()
